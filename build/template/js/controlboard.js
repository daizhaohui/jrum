...
(function($, window, document, undefined){
    ...
    function _insertOneLevelMenu(menuItem) {
        var i,
            ...
            template = '<div class="sidebar-title data-tipso" data-tipso="{label}" data-id="{id}">' +
    ...
    function _insertTwoLevelMenu(dom,menuItem,index) {
        var i,
            ...
            template = '<ul class="sidebar-trans" style="height:auto;">' +
                '<li class="nav-item menu-scope data-tipso" data-tipso="{label}" data-id="{id}" data-url="{url}">' +
                '<a href="" class="sidebar-trans menu-scope" data-submenu="{index}">' +
                '<div class="nav-icon sidebar-trans"><span class="{icon}"></span></div>' +
        ...
        replacedData = {
            label       : menuItem.label,
            id          : menuItem.id,
            icon        : menuItem.icon || defaultIconClass,
            index       : len>0 ? index:"",
    ...
    function _createLeftMenu(menuItems,options) {
    ...
    function _createTopMenu(menuItems,options) {
        var i,
            menuItem,
            len = menuItems.length;
        ...
        function createOneColMenu(items,containerDom) {
            var i,
                ...
                template =  '<li  class="topbar-info-btn" data-id="{id}">' +
                    '<span class="icon-image{iconClass}">{iconUrl}</span>' +
                    '<span class="info-btn-title">{label}</span>' +
                    '</li>',
                iconRule;
    ...
    $.extend(Plugin.prototype,{
        createLeftMenu:function(menuItems,options) {
            _createLeftMenu(menuItems,options);
            return this;
        },
        createTopMenu:function(menuItems,options) {
            _createTopMenu(menuItems,options);
            return this;
        },
...
(function($, window, document, undefined) {
    ...
    $.extend(Plugin.prototype, {
        ...
        show: function() {
            ...
            width = obj.content().length * 20;
            width = width>200?200:width;
            tipso_bubble.css({
                background: obj.settings.background,
                color: obj.settings.color,
                width: obj.settings.width>width?obj.settings.width:width
            }).hide();
